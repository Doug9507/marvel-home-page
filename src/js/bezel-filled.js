class BezelFilled {
	static get inputProperties() {
		return ["--bezel-color-primary", "--bezel-width"];
	}
	...
	paint(ctx, geom, properties, args) {
		...
		ctx.strokeStyle = properties.get("--bezel-color-primary");
		...
		ctx.closePath();
		ctx.fillStyle = properties.get("--bezel-color-primary");
		ctx.fill();
		ctx.stroke();
	}
}

registerPaint("bezelFilled", BezelFilled);
