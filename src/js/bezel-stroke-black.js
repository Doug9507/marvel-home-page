class BezelStrokeBlack {
	static get inputProperties() {
		return ["--bezel-color-third", "--bezel-width"];
	}
	...
	paint(ctx, geom, properties, args) {
		...
		ctx.strokeStyle = properties.get("--bezel-color-third");
...
registerPaint("bezelStrokeBlack", BezelStrokeBlack);
